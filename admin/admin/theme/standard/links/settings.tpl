<div class="header">{#SettingsModule#} {#Links#}</div>
...
<form method="post" action="">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="250" class="row_left">{#Links_settings_comments#}</td>
      <td class="row_right">
    ...
    <tr>
      <td class="row_left">{#Links_settings_rating#}</td>
      <td class="row_right">
    ...
    <tr>
      <td class="row_left">{#Links_settings_showflags#}</td>
      <td class="row_right">
