<div class="header">{#SettingsModule#} {#Gaming_cheats#}</div>
...
<form method="post" action="">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="250" class="row_left">{#Set_comments#}</td>
      <td class="row_right">
    ...
    <tr>
      <td class="row_left">{#Gaming_cheatsSettings_rate#}</td>
      <td class="row_right">
    ...
    <tr>
      <td class="row_left">{#Links_settings_brokenm#}</td>
      <td class="row_right">
    ...
    <tr>
      <td class="row_left">{#Gaming_cheatsSettings_flags#}</td>
      <td class="row_right">
