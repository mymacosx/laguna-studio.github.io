...
$(function(){
  ...
  $("a[href=#prev1]").on('click', function(e) {
    e.preventDefault();
  });
});
...
$(function(){
  ...
  $("a[href=#prev2]").on('click', function(e) {
    e.preventDefault();
  });
});
...
$(function(){
  ...
  $("a[href=#prev3]").on('click', function(e) {
    e.preventDefault();
  });
});
...
$(function(){
  ...
  $("a[href=#prev4]").on('click', function(e) {
    e.preventDefault();
  });
});
...
//         if (typeof ga !== 'undefined') ga('require', 'ecommerce');
//         goods_in_page_ids = [];
//         ecommerce_data = [];
...
//             easynetshop_buy(ens_jQuery(this).data('rel'));
//             return false;
//         });
...
//     }
//       });
//             $('.easynetshop-required[name=email]').each(function() {
//     var emailpattern = /^([a-z0-9_\.-])+@[a-z0-9-]+\.([a-z]{2,4}\.)?[a-z]{2,4}$/i;
//     if(emailpattern.test($(this).val())){
//       $(this).removeClass( "easynetshop-required-error" );
//     }
//     else {
//     $(this).addClass( "easynetshop-required-error" );
//                 $errorcount++;
//     }
//       });
//             $('.easynetshop-deliveryoptions  option:selected').each(function() {
//     if ($(this).val() == '0')
//       {
//                   $errorcount++;
//       $(this).parent().addClass( "easynetshop-required-error" );
//       }
//     else  {
//       $(this).parent().removeClass( "easynetshop-required-error" );
//       }
...
//                             'id': ecommerce_cart_data.ecommerce.purchase.actionField.id,
...
//                         if(typeof easynetshop_productscommerce != 'undefined') dataLayer.push(ecommerce_cart_data);
//                         if (typeof ga !== 'undefined')
//                             ga('ecommerce:send');
